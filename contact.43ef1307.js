    ...
    var e, t = {
            6176: (e, t, o) => {
                ...
                if (window.location.href.indexOf("de-DE") > -1) var C = "Das sieht super aus!",
                    B = "Bitte fülle schnell den Firmenname aus",
                    I = "Es sollten mindestens drei Buchstaben sein",
                    D = "Bitte fülle schnell die Unternehmens-Website aus",
                    S = "Es sollten mindestens drei Buchstaben sein",
                    L = "Bitte beschreibe Dein aktuelles Anliegen",
                    P = "Es sollten mindestens fünf Buchstaben sein",
                    A = "Hmm? Etwa außerirdisch?",
                    ...
                    N = "Unser geschäftlicher Sitz ist die europäische Union. Bitte akzeptieren Sie die Datenschutzbestimmungen.",
                    z = "Bitte wähle einer der oberen Punkte aus",
                    Z = "Ohne Budget können wir leider kein genaues Angebot erstellen",
                    H = "schließen",
                    F = "Schmeckt gut, wa? 🎉";
